...
function Homework(props) {
  return (
    <div className="homework">
      ...
      <p>Youve seen a couple examples of how to Route to new pages and fetch data from an API.</p>
      ...
      <p>In case you dont have a favorite API, here are some suggestions:</p>
